...
#define ALSA_CONFIG_DIR "/usr/local/share/alsa"
...
#define ALSA_PKGCONF_DIR "/usr/local/share/arm-alsa/lib/pkgconfig"

/* directory containing ALSA add-on modules */
#define ALSA_PLUGIN_DIR "/usr/local/lib/alsa_lib"
