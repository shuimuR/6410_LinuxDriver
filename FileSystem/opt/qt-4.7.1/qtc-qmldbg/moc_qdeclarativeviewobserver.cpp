...
#include "include/qdeclarativeviewobserver.h"
...
const QMetaObject QmlJSDebugger::QDeclarativeViewObserver::staticMetaObject = {
    { &QDeclarativeViewInspector::staticMetaObject, qt_meta_stringdata_QmlJSDebugger__QDeclarativeViewObserver,
...
void *QmlJSDebugger::QDeclarativeViewObserver::qt_metacast(const char *_clname)
{
    ...
    return QDeclarativeViewInspector::qt_metacast(_clname);
}

int QmlJSDebugger::QDeclarativeViewObserver::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QDeclarativeViewInspector::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
